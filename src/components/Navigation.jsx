...
const Module = ({icon, title, link}) => (
    <Link className="bg-gray-100 shadow-md hover:shadow-2xl text-3xl font-bold p-24 rounded-md flex flex-col gap-2 items-center hover:scale-105 transition-all duration-200" to={routeServer+link}>
        {icon}
        <span>{title}</span>
    </Link>
)
